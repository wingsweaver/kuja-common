...
/**
 * 抛出 {@link IllegalStateException} 异常的断言工具类。
 *
 * @author wingsweaver
 */
public final class AssertState {
    ...
    public static final class Named {
        ...
        public static void isTrue(String name, boolean condition) {
            AssertState.isTrue(condition, () -> MessageFormat.format("[{0}] should be true", name));
        }
        ...
        public static void isFalse(String name, boolean condition) {
            AssertState.isFalse(condition, () -> MessageFormat.format("[{0}] should be false", name));
        }
        ...
        public static void isNull(String name, Object object) {
            AssertState.isNull(object, () -> MessageFormat.format("[{0}] should be null", name));
        }
        ...
        public static void notNull(String name, Object object) {
            AssertState.notNull(object, () -> MessageFormat.format("[{0}] should not be null", name));
        }
        ...
        public static void isEmpty(String name, Object object) {
            AssertState.isEmpty(object, () -> MessageFormat.format("[{0}] should be empty", name));
        }
        ...
        public static void notEmpty(String name, Object object) {
            AssertState.notEmpty(object, () -> MessageFormat.format("[{0}] should not be empty", name));
        }
        ...
        public static void isBlank(String name, String text) {
            AssertState.isTrue(StringUtils.isBlank(text), () -> MessageFormat.format(
        ...
        public static void startsWith(String name, String text, String prefix) {
            AssertState.isTrue(StringUtils.startsWith(text, prefix), () -> MessageFormat.format(
        ...
        public static void endsWith(String name, String text, String suffix) {
            AssertState.isTrue(StringUtils.endsWith(text, suffix), () -> MessageFormat.format(
        ...
        public static void contains(String name, String text, String substring) {
            AssertState.isTrue(StringUtils.contains(text, substring), () -> MessageFormat.format(
        ...
        public static void likes(String name, String text, String regex) {
            AssertState.isTrue(text != null && text.matches(regex), () -> MessageFormat.format(
        ...
        public static void likes(String name, String text, Pattern pattern) {
            AssertState.isTrue(text != null && pattern.matcher(text).matches(), () -> MessageFormat.format(
        ...
        public static void equals(String name, Object value, Object target) {
            AssertState.isTrue(value.equals(target), () -> MessageFormat.format(
        ...
        public static <T extends Comparable<T>> void lessThan(String name, T value, T target) {
            AssertState.isTrue(value.compareTo(target) < 0, () -> MessageFormat.format(
        ...
        public static <T extends Comparable<T>> void between(String name, T value, T min, T max) {
            AssertState.isTrue(ObjectUtil.between(value, min, max), () -> MessageFormat.format(
        ...
        public static void in(String name, Object value, Object... targets) {
            AssertState.isTrue(ObjectUtil.in(value, targets), () -> MessageFormat.format(
