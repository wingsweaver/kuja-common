...
class ReadWriteLockedValueTest {
    @Test
    void test() {
        int startValue = 123456;
        ReadWriteLockedValue<Integer> value = new ReadWriteLockedValue<>(startValue);
    ...
    @Test
    void test2() {
        ReadWriteLockedValue<String> value = new ReadWriteLockedValue<>();
