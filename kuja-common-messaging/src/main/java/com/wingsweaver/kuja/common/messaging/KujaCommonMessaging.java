 ...
 * @author wingsweaver
 */
public final class KujaCommonMessaging {
    private KujaCommonMessaging() {
        // 禁止实例化
    }

    private static final ModuleVersion.Builder MODULE_VERSION_BUILDER = ModuleVersion.builder(KujaCommonMessaging.class);
