...
class SpringApplicationSimulationEnvironmentResolverTest {
    @Test
    void test() {
        SpringApplicationSimulationEnvironmentResolver environmentResolver = new SpringApplicationSimulationEnvironmentResolver();
