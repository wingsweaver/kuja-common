...
@WebMvcTest
@ContextConfiguration(classes = KujaCommonWebMvcJeeConfigurationTest.class)
@EnableKujaCommonWebMvcJee
@Import(KujaCommonWebMvcJeeConfigurationTest.TestConfiguration.class)
@PropertySource("classpath:application.properties")
class KujaCommonWebMvcJeeConfigurationTest {
    @Autowired
    private ApplicationContext applicationContext;

    @Test
    void test() {
        assertNotNull(this.applicationContext.getBean("kujaJeeServletRequestListener"));
        assertNotNull(this.applicationContext.getBean("kujaJeeBusinessContextFilter"));
        assertNotNull(this.applicationContext.getBean("kujaJeeDynamicLogContextFilter"));
        assertNotNull(this.applicationContext.getBean("kujaJeeWebMvcConfigurer"));
        assertNotNull(this.applicationContext.getBean("kujaJeeGlobalErrorController"));
        assertNotNull(this.applicationContext.getBean("kujaJeeServletResponseWriter"));
    }
